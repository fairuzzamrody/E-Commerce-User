...
function Listseluruhproduk() {
	...
	useEffect(() => {
		...
		// Set loading state to false after 1.5 seconds
	...
	return (
		<div>
			...
			<Navbar />
			<BreadCrumb />
			{isLoading && <Contentloading />} {/* Display loading component */}
			<Container>
				<div className="text-center mt-5 mb-5">
					<h1>
						<b>Telusuri Produk Dari Kami.</b>
					</h1>
				</div>
				<hr />
				<div className="d-flex justify-content-between align-items-center">
					<div>
						<span>
							Produk <b>{sortOption}</b> dari Kategori
							<b>
								"Meja".
								{/* Sesuaikan dengan kondisi sesungguhnya */}
							</b>
						</span>{" "}
						{/* Tampilkan teks opsi yang dipilih */}
					</div>
					<div className="d-flex align-items-center">
						...
						<Dropdown>
							...
							<Dropdown.Menu>
								...
								<Dropdown.Item
									onClick={() => handleSortOption("Harga Terendah")}
								>
									Harga Terendah
								</Dropdown.Item>
								...
								<Dropdown.Item
									onClick={() => handleSortOption("Produk Terbaru")}
								>
									Produk Terbaru
								</Dropdown.Item>
							</Dropdown.Menu>
