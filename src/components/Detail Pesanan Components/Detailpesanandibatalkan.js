...
function Detailpesanandibatalkan() {
  return (
    <div>
        <div>
			<Container>
    ...
    <p className='fw-bold text-end'>AR-F/ORD/C4NC3L-20230815-0001</p>
    </div>
     <div className="d-flex justify-content-between">
    <p>Diminta Oleh :</p>
				...
				<Card className="mb-4 mt-2">
					<Card.Body>
						...
						<Row>
							...
							<Col className="d-flex flex-column">
								<div>
									<p className="fw-bold" style={{ fontSize: "1.2rem", marginBottom: "15px"}}>
										Sofa Ruang Tamu
									</p>
									<p className="text-muted" style={{ marginBottom: "2px"}}>Varian : -</p>
									<span>Kuantitas : 1x</span>
								</div>
							</Col>
						</Row>
...
export default Detailpesanandibatalkan