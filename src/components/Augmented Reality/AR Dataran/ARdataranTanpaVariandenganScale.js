...
function ARdataranTanpaVariandenganScale() {
	useEffect(() => {
		...
		modelViewer.addEventListener("load", () => {
			...
			modelViewer.updateHotspot({
				...
				position: `${center.x + x2} ${center.y - y2} ${
					center.z + z2
				}`,
			});
			...
			modelViewer.updateHotspot({
				...
				position: `${center.x + x2 * 1.2} ${center.y - y2 * 1.1} ${
					center.z
				}`,
			});
			...
			modelViewer.updateHotspot({
				...
				position: `${center.x + x2 * 1.2} ${center.y} ${
					center.z - z2 * 1.2
				}`,
			});
			...
			modelViewer.updateHotspot({
				...
				position: `${center.x} ${center.y + y2 * 1.1} ${
					center.z - z2 * 1.1
				}`,
			});
	...
	const dataARdataranTanpaVarianDenganScale = {
		...
		iosSrc: "https://cdn.glitch.global/6a714b05-e482-46c1-9985-88f4f05c9148/SanderLounge.glb?v=1690982403449",
		poster: "https://cdn.glitch.global/6a714b05-e482-46c1-9985-88f4f05c9148/SanderLounge.glb?v=1690982403449",
		alt: "floor",
		...
		<div>
			...
			<Container>
				<model-viewer
					...
					// auto-rotate
					ar-placement="floor"
					src={dataARdataranTanpaVarianDenganScale.src}
					ios-src={dataARdataranTanpaVarianDenganScale.iosSrc}
					skybox-image={
						dataARdataranTanpaVarianDenganScale.skyboxImage
					}
...
export default ARdataranTanpaVariandenganScale;
